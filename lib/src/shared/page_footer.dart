...
class DefaultFooterNavigation extends StatefulWidget {
  const DefaultFooterNavigation({super.key});

  @override
  State<DefaultFooterNavigation> createState() =>
      _DefaultFooterNavigationState();
}

class _DefaultFooterNavigationState extends State<DefaultFooterNavigation> {
